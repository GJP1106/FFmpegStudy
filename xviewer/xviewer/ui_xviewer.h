...
"}"));
        ...
        cal->setGeometry(QRect(180, 0, 452, 384));
        cal->setStyleSheet(QString::fromUtf8("/* navigation bar */\n"
...
"}\n"
"QCalendarWidget QSpinBox::up-button { subcontrol-origin: border;  subcontrol-position: top right;  width:"
                        "65px; }\n"
